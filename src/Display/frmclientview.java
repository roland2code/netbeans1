 ...
 * @author rolae
 */
public class frmclientview extends javax.swing.JFrame {

    /**
     * Creates new form frmclientview
     */
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            frmappointment.txtidclient.setText(cod);
            frmappointment.txtclient.setText(valor);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmclientview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmclientview().setVisible(true);
            }
        });
    }
